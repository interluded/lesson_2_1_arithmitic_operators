...
public class Geometry
{
    public static void main(String[] args)
    {
        ...
        System.out.println(("The slope is  " + (integer_2 - integer_1) / (integer_4 - integer_3)));
        System.out.print("The midpoint is " + (integer_1 + integer_1)/2.0);
        System.out.println(" " + (integer_3 + integer_3)/2);
        double length_before_sqrt_x = Math.pow((integer_1 - integer_2), 2);
        double length_before_sqrt_y = Math.pow((integer_3 - integer_4), 2);
